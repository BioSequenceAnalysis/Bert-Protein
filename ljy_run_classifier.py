...
tf.app.flags.DEFINE_boolean('do_eval', False, 'Whether to evaluate after training')
tf.app.flags.DEFINE_boolean('do_save_model', True, 'Whether to save the model after training')
tf.app.flags.DEFINE_string('data_name', 'AMPScan', "the name of the dataset to use")
...
tf.app.flags.DEFINE_string('vocab_file', './vocab/vocab_1kmer.txt', 'Dictionary location')
tf.app.flags.DEFINE_string(
    'init_checkpoint', "./model/1kmer_model/model.ckpt", 'Initialization node of the model')
tf.app.flags.DEFINE_string('bert_config', "./bert_config_1.json", 'Bert configuration')
tf.app.flags.DEFINE_string(
